					...
					<form class="form-horizontal" data-toggle="validator" role="form" method="post" >
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input name="UserMail" type="email" class="form-control" id="UserMail" placeholder="E-mail" data-error="Cet email est invalide" class="form-control input-md" >
									<div class="help-block with-errors"></div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-4 control-label" for="Userpassword">Mot de passe</label>  
								<div class="col-md-4">
									<input name="Userpassword" type="text" class="form-control" id="Userpassword" placeholder="mot de passe" required class="form-control input-md" >
									<div class="help-block with-errors"></div>
								</div>
							</div>
							<div class="form-group">
