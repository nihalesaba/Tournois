	...
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				...
				<a href="<? echo url::gotolink("./user/courts/create "); ?>">
					<h4>Ajouter un nouveau terrain</h4>
				</a>
				<br>
				<table class="table table-striped table-advance table-hover">
					<tbody>
						<tr>
							<?php 
								$labels =  array("Numéro de terrain","Type de terrain", "Adresse" , "Propriété","Comment accéder au terrain?","Remarques","Disponible Samedi","Disponible Dimanche", "Actions" );
						...
						<tr>
							...
							<td><?php echo $result["CourtAccessComments"];  ?></td>
							<td><?php echo $result["CourtOwnerComments"];  ?></td>
