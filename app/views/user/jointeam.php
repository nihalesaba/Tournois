		...
		<div class="row">
			<div class="col-lg-10">
				...
				<div class="panel-body">
					...
					<select class="form-control" name="PaymentMethod2" required>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="radio">
								<label for="Bbq1">
									<input type="radio" name="Bbq2" id="Bbq1-0" value=1 >
										Oui
								</label>
							</div>
							<div class="radio">
								<label for="Bbq1">
									<input type="radio" name="Bbq2" id="Bbq1-1" value=0 checked="checked">
										Non
								</label>
							</div>
						</div>
					...
					<textarea   class="form-control" name="Comment2" rows=4 cols=40></textarea>
					<? form::enditem();?>
					<? form::submitbuttons();?>
					<? form::endform();?>
				</div>
